<?php
class Application_Form_frmFilters extends Zend_Form {
    ...
    public function formFields() {
        ...
        $this->_arrFields[] = array('formField' => 'path','type' => 'text', 'elements' => array('class' => 'contactElement','label' => 'Filtru','required' => true,'validators' => array(array('validator' => 'stringLength','options' => array(1, 128)))));
        return $this;
    }
