...
class Application_Form_frmRoles extends Zend_Form {
    ...
    public function formFields() {
		...
		$this->_arrFields[] = array('formField' => 'productivo_clients','type' => 'MultiCheckbox', 'elements' => array('MultiOptions' => array('r' => 'Read', 'a' => 'Add','m' => 'Modify', 'd' => 'Delete'),'class' => 'contactElement','label' => 'Clienti Productivo'));
