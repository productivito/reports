<?php
class Application_Form_frmPassword extends Zend_Form {
    ...
    public function formFields() {
		...
		$this->_arrFields[] = array('formField' => 'password','type' => 'password', 'elements' => array('class' => 'contactElement','label' => 'Parola noua','required' => true,'validators' => array(array('validator' => 'stringLength','options' => array(1, 128)))));
    ...
    private function formElements() {
        ...
        $this->addElement('submit', 'form_submit' ,array('label' => 'Schimba parola','style' => 'margin-right: 19px;'));
        return $this;
    }
    ...
    private function groupDecorators(){
        ...
        $formPartB->setDescription('* Camp Obligatoriu')
                  ->setDecorators(array(
            'FormElements',
            array('HtmlTag', array('tag' => 'div', 'style' => 'margin-top:20px;height:30px;','class' => 'submit')),
